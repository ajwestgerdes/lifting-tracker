...
import { GET_LIFTS, ADD_LIFT, DELETE_WORKOUT, DELETE_LIFT, LIFTS_LOADING, UPDATE_LIFT, GET_LIFT } from './types';
...
export const deleteLifts = (id) => dispatch => {
    console.log('in delete lift')
    axios.delete(`/lifts/delete/lift/${id}`)
        .then(res => dispatch({
            type: DELETE_LIFT,
            payload: id
        }))
